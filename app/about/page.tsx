...
export const metadata = genMeta({
  title: 'About Us - DriveNow Rentals',
  description: 'Learn about DriveNow Rentals, your trusted partner for premium car rentals. Committed to excellence, safety, and customer satisfaction since 2010.',
  keywords: ['about drivenow', 'car rental company', 'our story', 'why choose us'],
});
      ...
      <main className="min-h-screen">
        ...
        <section className="bg-gradient-to-r from-primary to-primary-light text-white py-20">
          <div className="container-custom">
            <h1 className="heading-lg mb-4">About DriveNow Rentals</h1>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Founded in 2010, DriveNow Rentals started with a simple mission: to provide high-quality, 
                  affordable car rental services to travelers and locals alike. Over the years, we've grown 
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  or a special occasion, DriveNow Rentals has the perfect vehicle for you.
                </p>
              </div>
